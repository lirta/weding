  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Jadwal Acara Samudra Wedding</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tabel</h3> <br>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  $queri ="SELECT * FROM pesanan inner join paket on pesanan.paket_id = paket.id
                                                  inner join pelanggan on pesanan.pelanggan_id=pelanggan.id WHERE status='proses'  ";
                    $hasil =mysqli_query($koneksi,$queri);
                    $no = 1;
                    while ($paket=mysqli_fetch_assoc($hasil)) {
                      $date=date('d M Y',strtotime($paket['tgl_pesta']))
                      ?>
                    <tr>
                      <td><?php echo "$no"; ?></td>
                      <td><?php echo "$date"; ?></td>
