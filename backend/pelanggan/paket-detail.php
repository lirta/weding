                  ...
                  <form method="post" action="paket-add-proses.php">
                      <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="paket" placeholder="Enter email" name="paket"  value="<?php echo "$paket[paket]"; ?>" disabled>
                        </div>
                      </div>
                      <div class="card-body">
                        <div class="form-group">
                            <label for="paket">Tanggal Pesta</label>
                            <input type="date" class="form-control" id="paket"  name="paket" >
                        </div>
                      </div>
                      <div class="card-body">
                        <div class="form-group">
                            <label for="paket">Alamat Pesta</label>
                            <input type="text" class="form-control" id="paket" placeholder="Enter alamat" name="paket" >
                        </div>
                      </div>
                      <!-- /.card-body -->
